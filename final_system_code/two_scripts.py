...
def onsite_main():
	...
	#	time res idea: read in all available files? divide number of files by 
		...
		f = open(height_file, "r+"); f.truncate()
		f.write(h + "\n")
		f.close()
		...
		time.sleep(120); print("woooorrd")
        ##print("wooooooooorkk")
        #print("worrrrrkk")
        # send string to ground station 
		message = str(end_time) + ";B=" + str(bat_level) + ";T=" + str(temperature) + ";H=" + str(h); print(message)
		send_string(message,TRX_ser); print("ahhhhhh")
        #print("ahhhhhhhggggg")
       # print("aggggggg")
