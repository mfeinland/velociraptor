...
import time
from receiver_functions import read_nmea, cereal_func, setFreq
from nmea2dino import nmea2dino
from reflector_height import reflector_height
from send_string import send_string
...
def main():
    ...
    # 	number of desired blocks  
		...
		try:
			...
			message = "Couldn't resolve reflector height"	
		send_string(message)
